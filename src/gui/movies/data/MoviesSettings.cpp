...
void Movies::Settings::checkFirstRun()
{
...
void Movies::Settings::save() const
{
	QSettings settings(Helper::stdPathSettings(), QSettings::IniFormat);
...
void Movies::Settings::load()
{
	...
	_csv_settings.setHeader(CsvFileFavorites, FavoritesConverter::getDefaultCsvHeader());
